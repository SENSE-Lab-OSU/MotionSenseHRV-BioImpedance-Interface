...
RightSensor = bluetooth_reciver.MSenseDevice("RightMotionSense2", [ppg_sensor, accelorometer, led])
LeftSensor = bluetooth_reciver.MSenseDevice("LeftMotionSense2", [ppg_sensor, accelorometer, led])
